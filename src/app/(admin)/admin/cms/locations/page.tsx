...
const MOCK: Location[] = [
  { id: "1", name: "Main Hospital", address: "PMB 5538, Ile-Ife, Osun State", type: "main", phone: "+234 036 230 372", hours: "24/7", lat: "7.4924", lng: "4.5124", status: "active" },
  { id: "2", name: "Cardiology Centre", address: "Block A, OAUTHC Main Campus, Ile-Ife", type: "centre", phone: "+234 036 230 380", hours: "Mon–Fri 8am–5pm", lat: "7.4928", lng: "4.5130", status: "active" },
  { id: "3", name: "Radiology Department", address: "Block B, OAUTHC Main Campus, Ile-Ife", type: "department", phone: "+234 036 230 382", hours: "Mon–Fri 8am–4pm", lat: "7.4926", lng: "4.5128", status: "active" },
  { id: "4", name: "Eye Centre (LAUTECH)", address: "LAUTECH Teaching Hospital, Ogbomoso", type: "centre", phone: "+234 038 710 421", hours: "Mon–Sat 8am–5pm", lat: "8.1333", lng: "4.2500", status: "active" },
  { id: "5", name: "Emergency & Trauma Centre", address: "Main Gate, OAUTHC Campus, Ile-Ife", type: "centre", phone: "+234 036 230 400", hours: "24/7", lat: "7.4920", lng: "4.5120", status: "active" },
  { id: "6", name: "Cancer Research Centre", address: "Research Block, OAUTHC Main Campus", type: "centre", phone: "+234 036 230 391", hours: "Mon–Fri 9am–4pm", lat: "7.4930", lng: "4.5135", status: "active" },
  { id: "7", name: "Outpatient Department (OPD)", address: "OPD Block, OAUTHC Main Campus", type: "department", phone: "+234 036 230 375", hours: "Mon–Fri 8am–3pm", lat: "7.4922", lng: "4.5126", status: "active" },
  { id: "8", name: "Pharmacy", address: "Ground Floor, Main Hospital Block", type: "department", phone: "+234 036 230 376", hours: "24/7", lat: "7.4925", lng: "4.5123", status: "active" },
];
...
const EMPTY: Omit<Location, "id"> = { name: "", address: "", type: "department", phone: "", hours: "", lat: "", lng: "", status: "active" };
          ...
          <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input value={panel.data.name} onChange={(e) => setField("name", e.target.value)} placeholder="Location name" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-gray-600">Address</label>
                <input value={panel.data.address} onChange={(e) => setField("address", e.target.value)} placeholder="Full address" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input value={panel.data.phone} onChange={(e) => setField("phone", e.target.value)} placeholder="+234 xxx xxx xxxx" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-600">Opening Hours</label>
                  <input value={panel.data.hours} onChange={(e) => setField("hours", e.target.value)} placeholder="e.g. 24/7 or Mon–Fri 8am–5pm" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-600">Latitude</label>
                  <input value={panel.data.lat} onChange={(e) => setField("lat", e.target.value)} placeholder="e.g. 7.4924" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-600">Longitude</label>
                  <input value={panel.data.lng} onChange={(e) => setField("lng", e.target.value)} placeholder="e.g. 4.5124" className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-green-700 bg-gray-50" />
                </div>
              </div>
            </div>
