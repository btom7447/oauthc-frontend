...
export default function SchoolOverview({ name, image, paragraphs }: Props) {
    ...
    <section className="w-full bg-white py-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-2 mb-10">
          ...
          <h2 className="text-red-600 text-3xl md:text-4xl font-semibold font-yeseva">
            Overview
          </h2>
        </div>

        {/* Float image right on md+ */}
